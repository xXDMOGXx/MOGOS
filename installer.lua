...
function startInstall()
    ...
    if (setup == 1) then
        ...
        shell.run("pastebin get 41qPd7bg MOGOS/System/Programs/Framework/main.prg")
        shell.run("pastebin get XJMRu7M7 MOGOS/System/Programs/Login/main.prg")
        shell.run("pastebin get bKPyH6mz MOGOS/System/Programs/Desktop/main.prg")
        shell.run("pastebin get pJuEeR2E MOGOS/System/Programs/Desktop/Assets/Maps/main.map")
        shell.run("pastebin get 5JUZYdyG MOGOS/System/Programs/Paint.app/main.prg")
